...
# Análises bivariadas com variáveis numéricas
...
1. Income (Renda) vs Response:

2. Recency (Recência) vs Response: 

3. MntWines (Gastos com Vinhos) vs Response: 

4. MntMeatProducts (Gastos com Produtos de Carne) vs Response: 

5. MntFishProducts (Gastos com Produtos de Peixe) vs Response: 

6. MntSweetProducts (Gastos com Produtos Doces) vs Response: 
